    ...
    return (
        <div className="relative bg-gray-200 py-20">
            <div className="max-w-3xl mx-auto text-center mb-8">
                ...
                <NavLink to={`/empdashboard/viewtask/${JSON.parse(localStorage.getItem("user"))._id}`} className="mt-6 inline-block bg-purple-600 text-white py-2 px-4 rounded">View Task</NavLink>
            </div>
