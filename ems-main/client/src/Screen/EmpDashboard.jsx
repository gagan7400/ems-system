...
export default function EmpDashboard() {
    ...
    return (
        <div className="flex bg-gray-300 h-screen fixed  w-screen">
            <aside className={`z-3 flex flex-col text-gray-300 bg-gray-800 transition-all duration-300 ease-in-out ${isSidebarExpanded ? "w-64" : "w-20"} min-h-[403px] `} >
                ...
                <nav className="p-4 space-y-2 font-medium">
                    <NavLink to={`/empdashboard/viewtask/${name._id}`} className="flex items-center h-10 px-3 hover:bg-blue-600 hover:bg-opacity-25 rounded-lg transition-colors duration-150 ease-in-out focus:outline-none focus:shadow-outline" >
            ...
            <div className={`flex-1 flex flex-col  w-96`}>
                <header className="h-20 flex items-center justify-between px-6 bg-white ">
                    ...
                    <NavLink to={`/empdashboard/profile/`}><div className='  flex items-center justify-between gap-5 px-6 bg-white'>
